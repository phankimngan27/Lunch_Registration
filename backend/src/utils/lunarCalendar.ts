// Thuật toán chuyển đổi Dương lịch sang Âm lịch của Hồ Ngọc Đức
...
export function convertSolar2Lunar(dd: number, mm: number, yy: number, timeZone: number = 7): [number, number, number, number] {
  ...
  return [lunarDay, lunarMonth, lunarLeap, lunarYear];
}

/**
 * Check if a date is a vegetarian day (lunar 1st or 15th)
 */
